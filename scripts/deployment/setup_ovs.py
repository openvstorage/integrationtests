    ...
    if exitcode == 0:
        for key in output.splitlines():
            if key == 'DISTRIB_RELEASE=16.04':
                ...
                remote_con.process.execute('cd /tmp; wget http://10.100.129.100:8080/view/volumedriver/view/ubuntu/job/volumedriver-dev-release-ubuntu-16.04/lastSuccessfulBuild/artifact/volumedriver-core/build/debian/volumedriver-base_6.0.3-dev.201608310248.ff419d4_amd64.deb')
                remote_con.process.execute('cd /tmp; wget http://10.100.129.100:8080/view/volumedriver/view/ubuntu/job/volumedriver-dev-release-ubuntu-16.04/lastSuccessfulBuild/artifact/volumedriver-core/build/debian/volumedriver-server_6.0.3-dev.201608310248.ff419d4_amd64.deb')
                remote_con.process.execute('cd /tmp; wget http://10.100.129.100:8080/view/alba2/job/alba_docker_generic_package_ubuntu-16.04/lastSuccessfulBuild/artifact/alba_0.9.18_amd64.deb')
                remote_con.process.execute('cd /tmp; wget http://10.100.129.100:8080/view/alba2/job/arakoon_docker_generic_package_ubuntu-16.04/lastSuccessfulBuild/artifact/arakoon_1.9.10_amd64.deb')
                remote_con.process.execute('apt-get install -y gdebi-core')
                remote_con.process.execute('cd /tmp; gdebi -n ./volumedriver-base_6.0.3-dev.201608310248.ff419d4_amd64.deb')
                remote_con.process.execute('cd /tmp; gdebi -n ./volumedriver-server_6.0.3-dev.201608310248.ff419d4_amd64.deb')
                remote_con.process.execute('cd /tmp; gdebi -n ./alba_0.9.18_amd64.deb')
                remote_con.process.execute('cd /tmp; gdebi -n ./arakoon_1.9.10_amd64.deb')
